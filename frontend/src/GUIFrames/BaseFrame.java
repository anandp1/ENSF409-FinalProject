...
public class BaseFrame extends javax.swing.JFrame {
    ...
    public BaseFrame(Database db) {
        // initalize all components for the GUI
        initComponents();
        this.db = db;
    }
     ...
     */
    // auto generated code via NetBeans
    ...
    private void loginMouseReleased(java.awt.event.MouseEvent evt) {
        ...
        // open login frame and discard the current one
        this.dispose();
    ...
    private void emailButtonMouseClicked(java.awt.event.MouseEvent evt) {
        // get the property selected from the list
        ...
        if(selectedProperty == null) {
            ...
            // prompt user for preferred email and message to landlord
            ...
            // extract the id from the selected property
    ...
    private void SearchButtonMouseReleased(java.awt.event.MouseEvent evt) {
        ...
        // get all matching properties to the criteria that was selected
